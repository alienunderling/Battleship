...
public class AddTest : Assertion {
	...
	// framework.
	[Test]
	public void twoNumbersAddedTogether {
		// inside here you will exercise your class and then call Assert()
		int num1 = 1;
		int num2 = 1;
		
		int resultEquals2 = Add(num1, num2);
		
		Assert(resultEquals2, 2);
	}
